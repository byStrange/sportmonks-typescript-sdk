...
[![Development](https://img.shields.io/badge/Husky-Pre--commit%20hooks-blue.svg)]()
...
```bash
npm install sportmonks-typescript-sdk
```

## Quick Start

```typescript
import { SportMonksClient } from 'sportmonks-typescript-sdk';
